...
const Footer = () => {
  return (
    <>
  <footer className="py-5 mx-5 mt-5 bg-light shadow-sm  " >
    <div className="row">
      <div className="col-6 col-md-2 mb-3 mx-5 ">
        <h5>Section</h5>
        <ul className="nav flex-column">
          <li className="nav-item mb-2"><Link to="/" className="nav-link p-0 text-body-secondary">Home</Link></li>
          <li className="nav-item mb-2"><Link to="#" className="nav-link p-0 text-body-secondary">Conference Guidelines</Link></li>
