...
import { editSpeaker,getSpeaker } from '../api/speaker-api';
...
<form className="row">
<h3  className='text-center mt-5 mb-3'>Edit Speakers</h3>

  <div className="col-md-6">
    <label htmlFor="validationDefault01" className="form-label">Name of Speaker</label>
    <input type="text" className="form-control" id="validationDefault01" defaultValue="Mark" required onChange={(e)=>onValueChange(e)} name='nameofspeaker' value={speaker.nameofspeaker}/>
  </div>
  <div className="col-md-6">
    <label htmlFor="validationDefault01" className="form-label">Url of Speaker</label>
    <input type="url" className="form-control" id="validationDefault01" defaultValue="WWW.xyz.com" required onChange={(e)=>onValueChange(e)} name='urlofspeaker' value={speaker.urlofspeaker}/>
  </div>
  <div className="col-md-6">
